...
import { submissionSchema } from "@/challenges/schemas/submission";
...
export default withApiAuth(
  nc<NextApiRequest, NextApiResponse>({
    ...
    withValidation(submissionSchema, async (req, res) => {
      ...
      return res
        ...
        .json(
          buildResponse({
            success: true,
            data: { challenge: challenge, flag: submittedFlag, correct },
          })
        );
    })
  )
